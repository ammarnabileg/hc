...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 1.6 · 2.3 · 2.5-أ · 2.5-د · 2.5-ب · 2.5 · 2.5-د-2 · 2.6-ب · 2.8 · 2.11-ب · 2.11-ح · 2.11-ط
...
- **ملفّات مسارات (35):**
  ...
  - `admin-content.php` — 96 مسارًا · البادئة `admin.` · 54 حارس صلاحيّة.
  ...
  - `admin-volunteer.php` — 102 مسارًا · البادئة `admin.` · `volunteer.` · `gamification.` · `rewards.` · `events.` · 97 حارس صلاحيّة.
