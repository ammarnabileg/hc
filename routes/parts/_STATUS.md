...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.3 · 2.5-أ · 2.5-ب · 2.5-د · 2.5 · 2.6-ب · 2.8 · 2.11-ح · 2.11-ب · 2.13 · 2.15-د · 2.15-ب
...
- **ملفّات مسارات (32):**
  ...
  - `admin-content.php` — 84 مسارًا · البادئة `admin.` · 46 حارس صلاحيّة.
  ...
  - `admin-volunteer.php` — 73 مسارًا · البادئة `admin.` · `volunteer.` · `gamification.` · `rewards.` · `events.` · 68 حارس صلاحيّة.
