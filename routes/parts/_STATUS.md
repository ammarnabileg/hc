...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 1.6 · 2.3 · 2.5-ب · 2.5-د · 2.5-أ · 2.5 · 2.5-د-2 · 2.6-ب · 2.8 · 2.11-ب · 2.11-ح · 2.11-ط
...
- **ملفّات مسارات (35):**
  ...
  - `admin-content.php` — 117 مسارًا · البادئة `admin.` · 67 حارس صلاحيّة.
  ...
  - `admin-ops.php` — 32 مسارًا · 21 حارس صلاحيّة.
  - `admin-screens24.php` — 45 مسارًا · البادئة `admin.` · 24 حارس صلاحيّة.
  - `admin-system.php` — 115 مسارًا · البادئة `admin.` · 60 حارس صلاحيّة.
  - `admin-volunteer.php` — 121 مسارًا · البادئة `admin.` · `volunteer.` · `investigations.` · `gamification.` · `rewards.` · `events.` · 115 حارس صلاحيّة.
  ...
  - `growth.php` — 24 مسارًا · البادئة `admin.` · 5 حارس صلاحيّة.
  - `home.php` — 15 مسارًا · البادئة `admin.` · 6 حارس صلاحيّة.
  - `learning.php` — 24 مسارًا · البادئة `learning.` · 11 حارس صلاحيّة.
  - `library.php` — 33 مسارًا · البادئة `admin.` · 14 حارس صلاحيّة.
  - `onboarding.php` — 9 مسارًا · 1 حارس صلاحيّة.
  - `public-pages.php` — 8 مسارًا · 0 حارس صلاحيّة.
  ...
  - `store.php` — 14 مسارًا · 2 حارس صلاحيّة.
  - `ui.php` — 16 مسارًا · 6 حارس صلاحيّة.
  - `volunteer-core.php` — 21 مسارًا · البادئة `volunteer.` · 14 حارس صلاحيّة.
