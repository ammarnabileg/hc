...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 1.6 · 2.3 · 2.5-ب · 2.5-أ · 2.5-د · 2.5 · 2.5-د-2 · 2.6-ب · 2.8 · 2.11-ط · 2.11-ب · 2.11-ح
...
- **ملفّات مسارات (35):**
  ...
  - `admin-content.php` — 100 مسارًا · البادئة `admin.` · 57 حارس صلاحيّة.
  ...
  - `admin-system.php` — 94 مسارًا · البادئة `admin.` · 44 حارس صلاحيّة.
  - `admin-volunteer.php` — 116 مسارًا · البادئة `admin.` · `volunteer.` · `investigations.` · `gamification.` · `rewards.` · `events.` · 110 حارس صلاحيّة.
  ...
  - `volunteer-core.php` — 19 مسارًا · البادئة `volunteer.` · 13 حارس صلاحيّة.
