...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.3 · 2.5-ب · 2.5-أ · 2.5-د · 2.5 · 2.6-ب · 2.8 · 2.11-ح · 2.11-ب · 2.13 · 2.15-د · 2.15-ب
...
- **ملفّات مسارات (32):**
  - `account.php` — 23 مسارًا · 10 حارس صلاحيّة.
  - `admin-content.php` — 83 مسارًا · البادئة `admin.` · 46 حارس صلاحيّة.
  - `admin-core.php` — 21 مسارًا · البادئة `admin.` · 19 حارس صلاحيّة.
  - `admin-ops.php` — 27 مسارًا · 17 حارس صلاحيّة.
  - `admin-screens24.php` — 40 مسارًا · البادئة `admin.` · 23 حارس صلاحيّة.
  - `admin-system.php` — 74 مسارًا · البادئة `admin.` · 37 حارس صلاحيّة.
  - `admin-volunteer.php` — 70 مسارًا · البادئة `admin.` · `volunteer.` · `gamification.` · `rewards.` · `events.` · 65 حارس صلاحيّة.
