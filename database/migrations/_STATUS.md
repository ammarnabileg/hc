...
- **مايجريشنز (231) — والقائم منها لا يُعدَّل (قاعدة البناء §1). الأحدث:**
...
## 🔄 الجاري الآن
<!-- بيدك:بداية:الجاري -->
- **الحالة:** `2026_08_26_100010_exam_entry_is_a_ticket_not_a_cooldown` — افتراضا
  `exams.attempts_allowed` و`exams.retry_cooldown_hours` كانا **1** و**24 ساعة**،
  وهما نقيض 4.2 («**بدون مدة انتظار** … **كل دخول = تذكرة**»): كلّ امتحانٍ
  يُنشئه فورم التدريب يولد مانعًا من رسب من الإعادة. صارا **0 / 0** (صفر = بلا
  حدّ / بلا انتظار)، وتُصحَّح الصفوف الحاملة عين القيمتين المخالفتين وحدها —
  والعمودان باقيان لضبط المالك (2.13).
- **آخر نقطة وصلنا لها:** 2026-08-03 — رحلة حقيقيّة: رسوب 14:26:00 ⟵ إعادة في
  نفس الدقيقة **مقبولة** (تذاكر 1 ⟵ 0).
- **الخطوة الجاية:** —
<!-- بيدك:نهاية:الجاري -->
