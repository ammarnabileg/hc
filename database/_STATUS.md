...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** المخطّط والبذور والمصانع.
...
- **ملفّات أخرى (1):** `database.sqlite`
- **مجلّدات فرعيّة (4):** `data/` · `factories/` · `migrations/` · `seeders/` — ولكلٍّ منها وثيقتها.
