...
class ExamDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        $rows = [
            ...
            ['certificates.render.security_lines', 'certificates', 'عدد خطوط نقش الأمان', 'number', '10'],
            ['certificates.render.security_band', 'certificates', 'سماكة شريط النقش (نسبة من الارتفاع)', 'number', '0.045'],
            ['certificates.render.security_color', 'certificates', 'لون نقش الأمان', 'color', '#d4af37'],
            ['certificates.render.microtext_label', 'certificates', 'نصّ الأمان المصغّر (يتكرّر مع كود كلّ شهادة)', 'string', 'شهادة أصيلة'],
            ['certificates.render.microtext_color', 'certificates', 'لون النصّ المصغّر', 'color', '#9bb3ad'],
            ['certificates.render.microtext_y', 'certificates', 'موضع النصّ المصغّر رأسيًّا (نسبة)', 'number', '0.965'],
            ['certificates.render.microtext_size_ratio', 'certificates', 'مقاس النصّ المصغّر (نسبة من الارتفاع)', 'number', '0.006'],
