...
class GrowthDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        ...
        $rows = [
            ...
            // ---------------- 21.3-د — صفحة سياسة الخصوصيّة العامّة (بلا تسجيل دخول)
            ...
            ['ads.privacy_page.withdraw_cta_label', 'ads', 'صفحة الخصوصيّة: زرّ الذهاب لإعدادات الخصوصيّة', 'string', 'اذهب لإعدادات الخصوصيّة والأمان', false],
            ['ads.privacy_page.withdraw_guest_note', 'ads', 'صفحة الخصوصيّة: سطر التوضيح للزائر', 'text', 'لسّه معملتش حساب؟ اختيارك بيتسجّل على المتصفّح ده، وتقدر تغيّره من بانر الموافقة في أيّ وقت. وبعد ما تسجّل حسابك، هتقدر تديره من صفحة الخصوصيّة والأمان.', false],
