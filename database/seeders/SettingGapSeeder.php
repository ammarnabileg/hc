...
class SettingGapSeeder extends Seeder
{
    ...
    private static function misc(): array
    {
        return [
            ...
            /*
             | تتبّع مشاهدة الفيديو (4.1): «إنهاء الدرس = مشاهدة **+** اجتياز الاختبار».
             | كانت أرقام النافذة والنسبة محروقة، فلا يقدر المالك على تخفيف الشرط
             | لدرسٍ طويل ولا تشديده — والقيم هنا مطابقة لِما يقرؤه الكود اليوم.
             */
            ['learning.video.require_watch', 'learning', 'اشتراط مشاهدة الفيديو لإنهاء الدرس', 'bool', '1', 'إطفاؤه يجعل الاختبار وحده كافيًا.'],
