...
class ChallengeDemoSeeder extends Seeder
{
    ...
    public function screenTextSettings(): void
    {
        $rows = [
            ...
            ['challenges.focus.live_note', 'challenges', '«حرب التركيز»: سطر طمأنة العدّاد', 'العدّاد ماشي على ساعة السيرفر، وبيكمل حتى لو قفلت الشاشة أو خرجت من التبويب.'],
            ...
            ['challenges.focus.subtitle', 'challenges', '«حرب التركيز»: السطر تحت العنوان', 'عمل عميق من غير مقاطعة، والمكافأة دقائق تركيز مش تذاكر.'],
