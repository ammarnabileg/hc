...
class ScreenTextDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        $rows = [
            ...
            ['images.export_panel.text_8', 'images', 'export-image: بلا قالب، تصميم المنصّة', 'بلا قالب، تصميم المنصّة بس'],
            ...
            ['growth.admin_index.subtitle_1', 'growth', 'index: كلّ رقم ونصّ في حلقات النموّ والاكتساب والتتبّع. من هنا لا ', 'كلّ رقم ونصّ في حلقات النموّ والاكتساب والتتبّع، بيتعدّل من هنا مش من الكود.'],
            ...
            ['growth.admin_index.text_6', 'growth', 'index: رفض المستخدم بيوقف البكسل وأحداث الخادم له فعليًّا. مش شكلي', 'رفض المستخدم بيوقف البكسل وأحداث الخادم له فعليًّا، مش شكليًّا بس.'],
