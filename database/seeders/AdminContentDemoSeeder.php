...
class AdminContentDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        $rows = [
            ...
            ['certificates.designer.default_font', 'certificates', 'الخطّ الافتراضيّ', 'string', 'Alexandria'],
            ...
            // ⭐ بلوك إعدادات دليل المستخدم (12.6-ج سطر 5087 — فجوة مسدودة):
            // Toggle البحث · Toggle «هل كان مفيدًا؟» + نصّه · Toggle التصنيفات ·
            // الوسوم · نصّ الحالة الفارغة (إنجليزيّ) — انظر `HelpGuideSettings`.
            ['help.search_enabled', 'help', 'تفعيل البحث داخل الدليل', 'bool', '1'],
            ...
            ['admin_content.help_guide.toggle_search', 'admin_content', 'لافتة توجّل: تفعيل البحث داخل الدليل', 'string', 'تفعيل البحث داخل الدليل'],
            ['admin_content.help_guide.toggle_feedback', 'admin_content', 'لافتة توجّل: تفعيل «هل كان مفيدًا؟»', 'string', 'تفعيل «هل كان مفيدًا؟»'],
            ['admin_content.help_guide.toggle_sidebar_categories', 'admin_content', 'لافتة توجّل: إظهار التصنيفات', 'string', 'إظهار التصنيفات فوق الأدلّة'],
            ['admin_content.help_guide.feedback_text_en', 'admin_content', 'لافتة: نصّ «هل كان مفيدًا؟» إنجليزيّ', 'string', 'نصّ «هل كان مفيدًا؟» (إنجليزيّ)'],
            ['admin_content.help_guide.empty_text_en', 'admin_content', 'لافتة: نصّ الحالة الفارغة إنجليزيّ', 'string', 'نصّ الحالة الفارغة (إنجليزيّ)'],
            ['admin_content.help_guide.categories_label', 'admin_content', 'اسم إعداد قائمة التصنيفات', 'string', 'تصنيفات دليل المستخدم'],
            ['admin_content.help_guide.tags_label', 'admin_content', 'اسم إعداد قائمة الوسوم', 'string', 'وسوم دليل المستخدم'],
            ['admin_content.help_guide.page_title', 'admin_content', 'عنوان شاشة إعدادات الدليل', 'string', 'إعدادات دليل المستخدم'],
            ['admin_content.help_guide.page_subtitle', 'admin_content', 'وصف شاشة إعدادات الدليل', 'string', 'البحث و«هل كان مفيدًا؟» والتصنيفات والوسوم ونصّ الحالة الفارغة.'],
            ['admin_content.help_guide.toggles_title', 'admin_content', 'عنوان بلوك التوجّلات', 'string', 'البحث والتقييم والتصنيفات'],
            ['admin_content.help_guide.categories_heading', 'admin_content', 'عنوان قسم التصنيفات', 'string', 'تصنيفات الدليل'],
            ['admin_content.help_guide.categories_add', 'admin_content', 'زرّ إضافة تصنيف', 'string', 'إضافة تصنيف'],
            ['admin_content.help_guide.categories_placeholder', 'admin_content', 'Placeholder صفّ تصنيف جديد', 'string', 'تصنيف جديد'],
            ['admin_content.help_guide.categories_remove', 'admin_content', 'وصف زرّ حذف تصنيف', 'string', 'حذف التصنيف'],
            ['admin_content.help_guide.categories_save', 'admin_content', 'زرّ حفظ التصنيفات', 'string', 'حفظ التصنيفات'],
            ['admin_content.help_guide.categories_defaults_hint', 'admin_content', 'تلميح افتراضيّ التصنيفات', 'string', 'الافتراضيّ:'],
            ['admin_content.help_guide.tags_heading', 'admin_content', 'عنوان قسم الوسوم', 'string', 'وسوم الدليل'],
            ['admin_content.help_guide.tags_add', 'admin_content', 'زرّ إضافة وسم', 'string', 'إضافة وسم'],
            ['admin_content.help_guide.tags_placeholder', 'admin_content', 'Placeholder صفّ وسم جديد', 'string', 'وسم جديد'],
            ['admin_content.help_guide.tags_remove', 'admin_content', 'وصف زرّ حذف وسم', 'string', 'حذف الوسم'],
