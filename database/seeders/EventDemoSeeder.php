...
class EventDemoSeeder extends Seeder
{
    ...
    public function screenTextSettings(): void
    {
        $rows = [
            ...
            ['events.show.full_note', 'صفحة الفعاليّة: سطر اكتمال العدد', 'العدد اكتمل في الفعاليّة دي. تابعنا عشان بننزل مواعيد جديدة.'],
    ...
    public function settings(): void
    {
        $rows = [
            ...
            ['events.checkin.qr_hint', 'events', 'شرح الـQR للمتدرّب', 'text', 'اعرض الرمز ده للمنظّم عشان يمسحه، وبيتجدّد كلّ'],
            ...
            ['events.registrations.invite_segment_body_placeholder', 'events', 'مثال نصّ دعوة الشريحة', 'text', 'مثال: يشرّفنا حضورك، والتفاصيل في صفحة الفعاليّة.'],
            ...
            ['referral.calc.passive_line', 'growth', 'شريط الدخل السلبيّ', 'string', 'دخل سلبيّ حقيقيّ، من غير أيّ مجهود بعد الدعوة'],
