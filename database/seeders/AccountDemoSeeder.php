...
class AccountDemoSeeder extends Seeder
{
    ...
    public function screenTextSettings(): void
    {
        $rows = [
            ...
            // ⭐ سحب/تغيير موافقة التتبّع في أيّ وقت من هذه الشاشة (21.3-د · 24.5)
            ['account.privacy.tracking_title', 'الخصوصيّة: عنوان بلوك موافقة التتبّع', 'الموافقة على التتبّع'],
            ['account.privacy.tracking_hint', 'الخصوصيّة: شرح بلوك موافقة التتبّع', 'ده اختيارك بخصوص تتبّع الإعلانات والقياس، وتقدر تغيّره أو تسحبه في أيّ وقت.'],
            ['account.privacy.tracking_save', 'الخصوصيّة: زرّ حفظ موافقة التتبّع', 'احفظ اختياري'],
            ['account.privacy.tracking_policy_link', 'الخصوصيّة: رابط سياسة الخصوصيّة العامّة', 'سياسة الخصوصيّة'],
            ...
            ['account.search.privacy_note', 'البحث: سطر سياسة الخصوصيّة', 'البحث بالبريد أو رقم الموبايل وسيلة وصول بس، والنتيجة بتفتح البروفايل العامّ من غير أيّ بيانات حسّاسة.'],
            ...
            // ✂️ القصّ المربّع **بيد المستخدم** لا تلقائيًّا (2.7-1)
            ['account.settings.avatar_crop_cancel', 'الإعدادات: زرّ إلغاء قصّ الصورة', 'إلغاء'],
            ['account.settings.avatar_crop_confirm', 'الإعدادات: زرّ تأكيد قصّ الصورة', 'تأكيد القصّ'],
            ['account.settings.avatar_crop_done', 'الإعدادات: رسالة تمام القصّ', 'تمّ القصّ ✓، تقدر تحفظ دلوقتي.'],
            ['account.settings.avatar_crop_hint', 'الإعدادات: شرح محرّر قصّ الصورة', 'حرّك الصورة جوّه المربّع واظبط التكبير، اللي بيّن جوّه بالظبط هو اللي هيتحفظ.'],
            ['account.settings.avatar_crop_required', 'الإعدادات: تنبيه أنّ القصّ مطلوب قبل الحفظ', 'اقصّ الصورة الأوّل عشان تقدر تحفظها.'],
            ['account.settings.avatar_crop_stage_aria', 'الإعدادات: وصف منطقة القصّ لقارئ الشاشة', 'منطقة القصّ: اسحب بالماوس أو بإصبعك، والأسهم تحرّك، و+ و− يكبّرا ويصغّرا.'],
            ['account.settings.avatar_crop_title', 'الإعدادات: عنوان محرّر قصّ الصورة', 'اقصّ صورتك'],
            ['account.settings.avatar_crop_zoom', 'الإعدادات: لافتة شريط التكبير في القصّ', 'التكبير'],
            ['account.settings.avatar_hint', 'الإعدادات: شرح الصورة الشخصيّة (:kb)', 'هتقصّها مربّعة بنفسك قبل الحفظ، وأقصى حجم :kb كيلوبايت.'],
            ...
            ['account.settings.email_channel_hint', 'الإعدادات: شرح قناة البريد', 'ده بيوقف رسايل المنشورات على بريدك بس، ورموز الدخول واستعادة كلمة السرّ هتفضل توصلك دايمًا.'],
