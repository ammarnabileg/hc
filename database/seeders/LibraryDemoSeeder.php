...
class LibraryDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        $rows = [
            ...
            ['reader.protection_note', 'reader', 'سطر الحماية أسفل القارئ', 'text', 'الملفّ ده بيتقرا جوّه الموقع بس، من غير تحميل ولا رابط مباشر، ونسختك عليها اسمك وكودك.'],
            ['reader.fallback.message', 'reader', 'رسالة تعذّر محرّك العرض', 'text', 'محرّك عرض الـPDF مش مركّب على السيرفر دلوقتي، فبنعرض لك صفحات بديلة مؤقّتًا لحدّ ما يتفعّل، وملفّك محفوظ زيّ ما هو.'],
            ...
            ['cv.template.admin.decor_hint', 'cv', 'تلميح الكانفس', 'text', 'اسحب أيّ عنصر لتغيير موضعه، والمحتوى خلفه معاينة حقيقيّة لقالب السيرة.'],
            ...
            ['cv.guest.note', 'cv', 'ملاحظة القالب المجّانيّ بلا تسجيل', 'text', 'إنت بتجرّب القالب المجّانيّ من غير تسجيل. التحميل بيطلب إنشاء حساب، وشغلك محفوظ لحدّ ما تسجّل.'],
            ...
            ['attestations.page.subtitle', 'attestations', 'سطر تعريف الإفادة', 'string', 'إثباتٌ موثّق من المنصّة، مجّانًا من غير تذاكر.'],
    ...
    /**
     * قالبان — بعدد التصاميم الموجودة فعلًا، واحدٌ مجّانيّ باب دخول (21.2-ج)
     * والآخر بالتذاكر.
     *
     * ⭐ كانت خمسة أسماء في الكتالوج وتصميمان اثنان تحتها فقط: «تنفيذيّ» و«مبدع»
     * يشيران إلى `modern` و«أكاديميّ» يشير إلى `classic` — فمن يدفع في «مبدع»
     * (وكان أغلى بتذكرة) يستلم مخرَجًا مطابقًا بايتًا ببايت لـ«مودرن» الأرخص.
     * وعدٌ مدفوع بلا منتجٍ خلفه، فحُذفت الأسماء الثلاثة بدل اختراع تصاميم وهميّة.
     * والأدمن يضيف قوالبه بنفسه من الشاشة متى وُجد تصميمٌ حقيقيّ (نصّ 9).
     *
     * الصفوف القديمة في قواعد البيانات القائمة تُرحَّل — لا تُبتَر — في
     * `2026_09_11_120000_trim_cv_templates_to_real_designs`.
     */
