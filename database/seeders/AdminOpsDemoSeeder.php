...
class AdminOpsDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        ...
        $rows = [
            ...
            // ---------------- خطّ التحديث الآمن (2.11-ب · د · هـ · ح · ط)
            ...
            ['updates.preflight.required_extensions', 'updates', 'امتدادات PHP المطلوبة للتحديث', 'json', json_encode(['pdo', 'json', 'zip'])],
            ['updates.preflight.writable_paths', 'updates', 'مجلّدات لازم تكون قابلة للكتابة', 'json', json_encode([
