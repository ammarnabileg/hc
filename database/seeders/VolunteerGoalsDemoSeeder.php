...
class VolunteerGoalsDemoSeeder extends Seeder
{
    ...
    public function settings(): void
    {
        $rows = [
            ...
            // ---------------- 23 — 1.2 · 1.6: مسودّات الملفّات
            ['goals.build.file_track_key', 'goals', 'مفتاح مسار الملفّات', 'string', 'case_file'],
            ['goals.build.file_draft.max_invitations', 'goals', 'سقف دعوات مسودّة الملفّ الواحدة', 'number', '20'],
            ...
            ['goals.editable.goal_description', 'goals', 'حقل: وصف الهدف', 'string', 'وصف الهدف'],
            ['goals.editable.goal_reason', 'goals', 'حقل: سبب الهدف', 'string', 'سبب الهدف'],
            ['goals.editable.milestone_name', 'goals', 'حقل: اسم المَعلَم', 'string', 'اسم المَعلَم'],
            ['goals.editable.milestone_verification_criteria', 'goals', 'حقل: معيار تحقّق المَعلَم', 'string', 'معيار تحقّق المَعلَم'],
            ['goals.editable.package_name', 'goals', 'حقل: اسم الحزمة', 'string', 'اسم الحزمة'],
            ['goals.editable.task_title', 'goals', 'حقل: اسم المهمّة', 'string', 'اسم المهمّة'],
            ['goals.editable.task_brief', 'goals', 'حقل: بريف المهمّة', 'string', 'بريف المهمّة'],
            ['goals.editable.task_deliverable_spec', 'goals', 'حقل: شكل المخرجات', 'string', 'شكل المخرجات'],
            ['goals.editable.task_vxp_value', 'goals', 'حقل: قيمة نقاط الإنتاج (VXP)', 'string', 'قيمة نقاط الإنتاج (VXP)'],
