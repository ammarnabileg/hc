# 🗂️ `tests/Feature/Admin/Ops/fixtures/failing` — حالة المجلّد
...
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** كود «failing».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.11-ح
...
- **أصناف (2):**
  - `2030_02_01_000000_ops_failing_step_one.php`
  - `2030_02_02_000000_ops_failing_step_two.php`
