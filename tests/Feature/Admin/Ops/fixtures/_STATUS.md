# 🗂️ `tests/Feature/Admin/Ops/fixtures` — حالة المجلّد
...
- **مجلّدات فرعيّة (3):** `failing/` · `lossy/` · `migrations/` — ولكلٍّ منها وثيقتها.
...
- **المجلّد الأب:** `tests/Feature/Admin/Ops/_STATUS.md`.
