# 🗂️ `tests/Feature/Admin/Ops/fixtures/migrations` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** مخطّط قاعدة البيانات — المايجريشنز القائمة لا تُعدَّل، والنقص يُضاف بمايجريشن جديد لمجلّد `tests/Feature/Admin/Ops/fixtures`.
...
- **مايجريشنز (1) — والقائم منها لا يُعدَّل (قاعدة البناء §1). الأحدث:**
  - `2030_01_01_000000_create_ops_probe_table.php`
...
- **المجلّد الأب:** `tests/Feature/Admin/Ops/fixtures/_STATUS.md`.
