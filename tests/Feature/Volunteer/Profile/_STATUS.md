# 🗂️ `tests/Feature/Volunteer/Profile` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** الفجوة 2: مسار موافقة إظهار التواصل كاملًا (13.4-م-2) —.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 10.0-د · 10.0 · 13.4-ك · 13.4-م · 13.4-م-1 · 13.4-م-2 · 13.4-م-4 · 13.4-م-5
...
- **أصناف (3):**
  - `ConsentFlowTest.php` — الفجوة 2: مسار موافقة إظهار التواصل كاملًا (13.4-م-2) —
  - `ProfileTestCase.php` — قاعدة اختبارات «بروفايل المتطوّع» (13.4-م · 10.0) — تبني الهيكل التجريبيّ
  - `VolunteerProfileTabsTest.php` — الفجوة 1: التابات الخمس تُحقَن فعلًا في البروفايل الواحد (13.4-م · 10.0-د)،
