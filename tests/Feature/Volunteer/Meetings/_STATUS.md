# 🗂️ `tests/Feature/Volunteer/Meetings` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** تسجيل حضور الاجتماعات وقيمته على درجة الالتزام (13.4-ن-ب · 24.4).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 12.2.1-ب · 13.4-ن-ب · 13.4-ط · 24.4
...
- **أصناف (5):**
  - `MeetingsAttendanceTest.php` — تسجيل حضور الاجتماعات وقيمته على درجة الالتزام (13.4-ن-ب · 24.4).
  - `MeetingsDemoSeederTest.php` — سيدر الديمو لازم يشتغل من أوّل مرّة على قاعدة نظيفة،
  - `MeetingsObjectionTest.php` — المعاملات والاعتراضات (13.4-ط · 24.4).
  - `MeetingsScreensTest.php` — كلّ شاشة وكلّ تاب في المجال يُفتَح فعلًا (2.15: التاب يُحمَّل عند فتحه).
  - `MeetingsTestCase.php` — أساس اختبارات مجال الاجتماعات: عضويّات وصلاحيّات حقيقيّة،
