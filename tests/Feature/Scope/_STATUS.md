# 🗂️ `tests/Feature/Scope` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** ⭐ **النطاق إلزاميّ مع كلّ صلاحيّة** (الدستور 12.2.1-ب).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 12.0 · 12.2.1-ب · 12.2.1-ز-3 · 12.2.1-ز-5 · 12.6
...
- **أصناف (2):**
  - `ScopedListsTest.php` — ⭐ **النطاق إلزاميّ مع كلّ صلاحيّة** (الدستور 12.2.1-ب).
  - `SidebarEntryPointsTest.php` — ⭐ **صفحات مبنيّة بلا مدخل في السايد بار** (الدستور 12.0).
