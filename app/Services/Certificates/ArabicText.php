...
{
    /**
     * لكلّ حرف: [نهائيّ، ابتدائيّ، وسطيّ] — و null يعني أنّ الحرف لا يقبل هذه الصورة.
     *
     * أمّا **الصورة المنفصلة فنكتبها بالحرف الأصليّ نفسه** لا برمزها في نطاق FE،
     * لأنّ كثيرًا من الخطوط العربيّة (ومنها Cairo) لا تعرّف رموز «المنفصل» أصلًا
     * وتكتفي بالحرف الأساسيّ — فلو استعملناها خرجت مربّعاتٍ فارغة.
     */
    private const FORMS = [
        0x0621 => [null, null, null],
        0x0622 => [0xFE82, null, null],
        0x0623 => [0xFE84, null, null],
        0x0624 => [0xFE86, null, null],
        0x0625 => [0xFE88, null, null],
        0x0626 => [0xFE8A, 0xFE8B, 0xFE8C],
        0x0627 => [0xFE8E, null, null],
        0x0628 => [0xFE90, 0xFE91, 0xFE92],
        0x0629 => [0xFE94, null, null],
        0x062A => [0xFE96, 0xFE97, 0xFE98],
        0x062B => [0xFE9A, 0xFE9B, 0xFE9C],
        0x062C => [0xFE9E, 0xFE9F, 0xFEA0],
        0x062D => [0xFEA2, 0xFEA3, 0xFEA4],
        0x062E => [0xFEA6, 0xFEA7, 0xFEA8],
        0x062F => [0xFEAA, null, null],
        0x0630 => [0xFEAC, null, null],
        0x0631 => [0xFEAE, null, null],
        0x0632 => [0xFEB0, null, null],
        0x0633 => [0xFEB2, 0xFEB3, 0xFEB4],
        0x0634 => [0xFEB6, 0xFEB7, 0xFEB8],
        0x0635 => [0xFEBA, 0xFEBB, 0xFEBC],
        0x0636 => [0xFEBE, 0xFEBF, 0xFEC0],
        0x0637 => [0xFEC2, 0xFEC3, 0xFEC4],
        0x0638 => [0xFEC6, 0xFEC7, 0xFEC8],
        0x0639 => [0xFECA, 0xFECB, 0xFECC],
        0x063A => [0xFECE, 0xFECF, 0xFED0],
        0x0641 => [0xFED2, 0xFED3, 0xFED4],
        0x0642 => [0xFED6, 0xFED7, 0xFED8],
        0x0643 => [0xFEDA, 0xFEDB, 0xFEDC],
        0x0644 => [0xFEDE, 0xFEDF, 0xFEE0],
        0x0645 => [0xFEE2, 0xFEE3, 0xFEE4],
        0x0646 => [0xFEE6, 0xFEE7, 0xFEE8],
        0x0647 => [0xFEEA, 0xFEEB, 0xFEEC],
        0x0648 => [0xFEEE, null, null],
        0x0649 => [0xFEF0, null, null],
        0x064A => [0xFEF2, 0xFEF3, 0xFEF4],
        // حروف فارسيّة/أردية شائعة في الأسماء
        0x067E => [0xFB57, 0xFB58, 0xFB59],
        0x0686 => [0xFB7B, 0xFB7C, 0xFB7D],
        0x0698 => [0xFB8B, null, null],
        0x06A9 => [0xFB8F, 0xFB90, 0xFB91],
        0x06AF => [0xFB93, 0xFB94, 0xFB95],
        0x06CC => [0xFBFD, 0xFBFE, 0xFBFF],
    ];
    ...
    private static function shape(array $items): array
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $out[] = match (true) {
                $prevConnects && $nextConnects && $forms[2] !== null => $forms[2],
                $prevConnects && $forms[0] !== null => $forms[0],
                $nextConnects && $forms[1] !== null => $forms[1],
                default => $value, // المنفصل = الحرف الأصليّ
            };
        }
    ...
    private static function connectsForward(array $item): bool
    {
        ...
        return (self::FORMS[$item[1]] ?? [null, null, null])[1] !== null;
    }
