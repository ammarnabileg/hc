# 🗂️ `app/Services/Gamification/Exceptions` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «Exceptions» ضمن: التلعيب: XP والمستويات والشارات والحروب والتحدّيات (13 · 15).
...
- **أصناف (1):**
  - `InsufficientBalanceException.php` — الرصيد لا يكفي لدخول التحدّي.
