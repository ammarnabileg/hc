# 🗂️ `app/Services/Gamification/Wars/Exceptions` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** خرق قاعدة حرب — ورسالتها موجَّهة للمستخدم مباشرةً:.
...
- **أصناف (1):**
  - `WarRuleException.php` — خرق قاعدة حرب — ورسالتها موجَّهة للمستخدم مباشرةً:
...
- **المجلّد الأب:** `app/Services/Gamification/Wars/_STATUS.md`.
