...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 21.3-أ · 21.3-د · 21.3-و · 21.3-ب · 21.3-ج
...
- **أصناف (7):**
  - `AdEvents.php` — ⭐ الأحداث الث�
  - `AdSignals.php` — ⭐ الأحداث الث�
  - `AudienceResolver.php` — ⭐ إعادة الاستهداف: **الشرائح تُبنى �
  - `Consent.php` — ⭐ ال�
  - `ConversionsApi.php` — ⭐ أحداث �
  - `PurchaseSignalObserver.php` — الجسر بين **لحظة اعت�
  - `TopupSignalObserver.php` — الجسر بين **لحظة اعت�
