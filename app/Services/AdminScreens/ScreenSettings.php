...
class ScreenSettings
{
    ...
    public static function catalog(): array
    {
        return [
            ...
            'report_schedules.download_link_hours' => [self::SCREEN_REPORTS, 'stats', 'صلاحيّة رابط التنزيل (ساعات)', 'number', '72', 'بعدها يتشال الملفّ نفسه من الخادم لا الرابط وحده.', false],
            'report_schedules.download_folder' => [self::SCREEN_REPORTS, 'stats', 'مجلّد ملفّات التنزيل المؤقّت', 'string', 'reports', 'داخل التخزين الخاصّ — مش المجلّد العامّ.', false],
            'report_schedules.download_body_template' => [self::SCREEN_REPORTS, 'stats', 'نصّ سطر رابط التنزيل', 'text', "الملفّ أكبر من حدّ المرفق (:size ميجابايت)، فرفعناه على رابط تنزيل مؤقّت:\n:url\nالرابط شغّال :hours ساعة، وبعدها يتشال. لو خلصت مدّته اضغط «شغّل الآن» من شاشة التقارير المجدولة.", 'المتغيّرات: :url · :hours · :size', false],
            'report_schedules.xlsx_row_limit' => [self::SCREEN_REPORTS, 'stats', 'سقف صفوف ملفّ Excel', 'number', '20000', 'الملفّ الذي لا يُفتَح لا ينفع أحدًا.', false],
            'report_schedules.pdf_row_limit' => [self::SCREEN_REPORTS, 'stats', 'سقف صفوف ملفّ PDF', 'number', '500', 'الـPDF للقراءة لا للتحليل — الأكبر منه يُصدَّر CSV أو Excel.', false],
            'report_schedules.pdf_headline' => [self::SCREEN_REPORTS, 'stats', 'سطر ترويسة ملفّ PDF', 'string', 'عن آخر :days يوم · :rows صفًّا · :date', 'المتغيّرات: :days · :rows · :date', false],
            'report_schedules.pdf_empty_line' => [self::SCREEN_REPORTS, 'stats', 'سطر PDF الفاضي', 'string', 'مافيش بيانات في المدى ده.', '', false],
            'report_schedules.pdf_truncated_line' => [self::SCREEN_REPORTS, 'stats', 'سطر تنبيه اقتطاع PDF', 'string', 'معروض أوّل :shown صفًّا من :total — الملفّ الكامل بصيغة CSV.', 'المتغيّرات: :shown · :total', false],
