...
class ScreenSettings
{
    ...
    public static function catalog(): array
    {
        $rows = [
            ...
            'report_schedules.pdf_row_limit' => [self::SCREEN_REPORTS, 'stats', setting('stats.screen_settings.catalog_65', 'سقف صفوف ملفّ PDF'), 'number', '500', setting('stats.screen_settings.catalog_66', 'الـPDF للقراءة لا للتحليل، والأكبر منه يُصدَّر CSV أو Excel.'), false],
        ...
        return array_map(
            fn (array $row) => self::stringify($row, 3, [2, 5], 4),
            $rows,
        );
    }
