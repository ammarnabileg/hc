...
class AtsPdfWriter
{
    ...
    {
        return setting('library.ats_pdf_writer.unavailable_reason_1', 'الخطّ العربيّ المضمَّن مش مرفوع على الخادم لسّه، فمقدرناش نطلع PDF عربيّ سليم. افتح النسخة القابلة للطباعة واحفظها PDF من المتصفّح، أو اطلب من الإدارة رفع الخطّ من الإعدادات.');
    }
