...
class ActivityWindow
{
    ...
    {
        return strtr(setting('workflow.activity_window.label_1', 'نافذة النشاط من :p1 لـ:p2'), [':p1' => (string) (self::format(self::startMinutes())), ':p2' => (string) (self::format(self::endMinutes()))]);
    }
