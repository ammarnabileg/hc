...
class OptionalCutService
{
     ...
     *
     * ومناديها **درجةٌ في سلّمٍ لا خدمةٌ وحدها**: `RepLadder::afterRepMovement()`
     * هو المدخل الواحد الذي تناديه جسور Rep الستّة، فيوقع الدرجات الثلاث
     * بترتيبها المنصوص (−8 ⟵ −9.5 ⟵ −10). وكان هذا الملفّ يحمل المدخل بنفسه
     * حين كانت الدرجة الوسطى وحدها مبنيّة — ولو بقي كذلك لَتفرّق ترتيبُ السلّم
     * على ستّة جسور بلا أن يصرخ أحد.
     *
