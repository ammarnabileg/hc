# 🗂️ `app/Services/Volunteer` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** التطوّع بكلّ طبقاته: المهام والاجتماعات والأداء والتقدير (13.4).
...
- **مجلّدات فرعيّة (10):** `Contributions/` · `Escalation/` · `Goals/` · `Meetings/` · `Objections/` · `Org/` · `People/` · `Profile/` · `Retention/` · `Tasks/` — ولكلٍّ منها وثيقتها.
...
- **الطبقات الأخرى لنفس المجال:** `app/Http/Controllers/Volunteer` · `resources/views/volunteer` · `routes/parts` · `tests/Feature/Volunteer`
