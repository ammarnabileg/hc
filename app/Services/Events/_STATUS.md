...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13 · 2.15-أ-4 · 2.16-ج · 2.17-أ · 8.1 · 13.3 · 21.1-أ · 21.3 · 24.5
...
- **أصناف (9):**
  ...
  - `CertificateBridge.php` — جسر الشهادات (8 · 12.5).
...
- **الاختبارات:** 5 ملفّ Feature في `tests/Feature/Events` — شغّلها بـ`php artisan test tests/Feature/Events`.
