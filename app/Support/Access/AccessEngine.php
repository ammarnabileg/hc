...
class AccessEngine
{
     ...
     *
     * ⚠️ **ويُفرَض وقت الكتابة لا وقت التقييم — عن قياسٍ لا عن سهو:** رفضُ النطاق
     * وقت التقييم كان **يسحب صلاحيّاتٍ قائمة** من أدوارٍ منصوصة لا يفتحها هذا الحدّ،
     * لا يسدّ ثغرة. فالسقف يُحرَس على **أبواب الكتابة** وحدها: شاشة الاستثناءات ·
     * محرّر الأدوار · و`RolePermissionSeeder::insertRows()` التي **تقصّ** كلّ صفٍّ
     * إلى أضيق ما تعرضه المصفوفة قبل كتابته — فلا منحَ يُسحَب ولا صفَّ يعلو.
     *
     * وكانت الإسنادات المزروعة تحمل **568 صفًّا فوق السقف**؛ صارت **صفرًا** على
     * مسار الإنتاج بعد المصالحة (`ScopeCeilingTest`). وتبقى **53 صفًّا** في
     * سيدرات العرض الستّة — بندٌ قائم في `database/seeders/_STATUS.md`.
     */
