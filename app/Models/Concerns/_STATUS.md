# 🗂️ `app/Models/Concerns` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** ربط المستخدم بمعماريّة الصلاحيّات (12.2.1).
...
- **أصناف (1):**
  - `HasAccessControl.php` — ربط المستخدم بمعماريّة الصلاحيّات (12.2.1).
...
- **المجلّد الأب:** `app/Models/_STATUS.md`.
