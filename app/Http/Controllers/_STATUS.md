...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.5-د · 2.6-ب · 2.8 · 2.9 · 2.13 · 7.6.1 · 13.4-هـ · 13.4-ب · 13.4-أ · 13.4-ج · 13.4-ص-ب · 19.4
...
- **مجلّدات فرعيّة (10):** `Admin/` · `AdminScreens/` · `Api/` · `Auth/` · `Growth/` · `Onboarding/` · `Setup/` · `Trainee/` · `Ui/` · `Volunteer/` — ولكلٍّ منها وثيقتها.
