...
class DepartmentController extends Controller
{
     ...
     *
     * ⭐ **الحكم كلّه عند الباب — والباب هنا `department.member` لا `permission`
     * وحده.** ولماذا حارسٌ آخر لهذه الشاشة دون «الهيكل التنظيميّ»؟ لأنّ مصدر
     * الحقّ يختلف: الهيكل **شجرةٌ تُمشى بسلسلة الإشراف** فحقُّه بالنطاق (وهو ما
     * أصلحه أ-3 ولا يُلمَس)، و«قسمي» نصُّها «**تاب لكلّ عضوٍ في القسم — القسم
     * كاملًا حتى لو كنتُ في فرعيّ**» (24.4-7) فحقُّها **بالعضويّة**: الزميلان في
     * قسمٍ واحد ليس أحدهما فوق الآخر ويعرف كلٌّ منهما زميله بنصّ الدستور.
     *
     * فالحارس يقبل **المفتاح + (النطاق أو عضويّة القسم)**، ويردّ من هو خارج
     * القسم ولا يغطّيه نطاقُه بـ403. والتعليل الكامل في
     * `App\Http\Middleware\EnsureDepartmentMembership`.
     *
     * ⚠️ ولا يفتح هذا الباب بياناتٍ مقفولة: التواصل يبقى مقنّعًا و«اطلب إظهار
     * الرقم» على حاله (13.4-م-2) — يقرّرها `ContactVisibility` بعد المرور.
     */
    ...
    public function requestConsent(Request $request, Membership $membership): RedirectResponse
    {
        ...
        // الباب حسمه `department.member`: المفتاح + (النطاق أو عضويّة القسم) — 24.4-7
