 ...
 * ولا إيقاف من اللوحة.
 *
 * ⭐ والعدد المبذور اليوم **اثنان لا خمسة** (2026-09-11): التصاميم الموجودة
 * فعلًا تحت `resources/views/cv/templates/` تصميمان، وكانت الخمسة أسماءً
 * ثلاثةٌ منها تشير إلى تصميمَي غيرها — فمن يدفع في «مبدع» الأغلى يستلم
 * مخرَج «مودرن» الأرخص حرفًا بحرف. والعدد «5» في النصّ وصفُ كتالوجٍ مبدئيّ
 * لا تعهُّدٌ ببيع اسمٍ بلا منتج، وهذه الشاشة نفسها هي الوفاء به: يضيف الأدمن
 * قالبه متى وُجد تصميمٌ حقيقيّ له — و`availableViews()` لا تعرض عليه إلّا
 * ملفّات العرض الموجودة بالفعل، فلا يتكرّر العيب من اللوحة.
 *
