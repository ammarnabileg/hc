# 🗂️ `resources/views/support` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «support» ضمن: كلّ واجهات المنصّة بالعربيّة — البساطة أوّلًا والموبايل شرط قبول (2.15).
...
- **مجلّدات فرعيّة (2):** `complaints/` · `help/` — ولكلٍّ منها وثيقتها.
