...
<noscript>
    ...
    <div style="position: fixed; inset-inline: 0; inset-block-end: 0; z-index: 70; max-block-size: 70vh; overflow-y: auto; padding: 1rem; background: var(--surface-raised, #ffffff); border-block-start: 1px solid var(--border, #dfddd5); color: var(--text, #171715); font-family: 'Alexandria', sans-serif;">
        <div style="max-inline-size: 44rem; margin-inline: auto;">
            ...
            <p style="font-size: .875rem; margin-block-end: .5rem; color: var(--text-muted, #65645f);">
            ...
            <ol style="font-size: .8125rem; margin-inline-start: 1.25rem; line-height: 1.9; color: var(--text-muted, #65645f);">
