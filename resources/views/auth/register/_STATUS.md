# 🗂️ `resources/views/auth/register` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «register».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.1 · 2.5-د · 2.5-أ · 2.5-ب · 2.5-ج · 2.9 · 2.13-أ · 2.14 · 2.17-ب · 12.7-د
...
- **شاشات/أجزاء بليد (2):**
  - `account.blade.php` — خطوتان معلنتان: المستخدم يعرف أين هو وكم بقي (2.9)
  - `identity.blade.php` — 1) اللقب: Select **مجمَّع بمجموعات** (عامّة · مهنيّة · أكاديميّة)
