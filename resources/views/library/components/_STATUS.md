# 🗂️ `resources/views/library/components` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** مكوّنات بليد خاصّة بالمجلّد الأب لمجلّد `resources/views/library`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.16-ج
...
- **شاشات/أجزاء بليد (1):**
  - `type-icon.blade.php` — تدريب: كتاب مفتوح
...
- ما فيش فجوة انفتحت هنا. `type-icon.blade.php` يرسم أيقونة النوع المنصوصة في 20.1
  (PDF / فيديو / صوت / HTML / تدريب / شهادة) — وأُثبِت ظهورها في `/library`.
<!-- بيدك:نهاية:المتبقّي -->
