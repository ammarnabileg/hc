# 🗂️ `resources/views/cards/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/cards`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 8.1 · 13.4-ر-ج
...
- **المجلّد الأب:** `resources/views/cards/_STATUS.md`.
