# 🗂️ `resources/views/achievements/components` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** مكوّنات بليد خاصّة بالمجلّد الأب لمجلّد `resources/views/achievements`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 2.9-5 · 2.9-7 · 2.16-ج · 2.16-ب · 7.2 · 7.3
...
- **شاشات/أجزاء بليد (6):**
  - `badge-icon.blade.php` — قرص الميدالية
  - `club-topbar.blade.php` — أيقونة الشروق: SVG مرسومة بهويّة المنصّة — بلا مكتبات (2.16-ج)
  - `heatmap.blade.php` — ضغطة يوم ⟵ تفاصيله (والعنوان يظهر بالمرور أيضًا)
  - `me-card.blade.php` — الكارت هو صفّي أنا — والتسمية تقولها صراحةً كما في صفّ اللوحة
  - `podium.blade.php`
  - `xp-row.blade.php` — الرصيد التراكميّ سياقًا — الرمز مع اللون دائمًا (2.16-ب)
...
- **المجلّد الأب:** `resources/views/achievements/_STATUS.md`.
