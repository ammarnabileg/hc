# 🗂️ `resources/views/growth/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/growth`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 21.3-أ · 21.3-د
