@php
    ...
    /*
     | ⭐ **الوصلة الأولى في سلسلة 21.2-ح** (المصدر ⟵ التسجيل ⟵ التفعيل ⟵ الشراء):
     | التقاط مصدر الاكتساب من وسم الرابط وحفظه ليعبر التسجيل.
     |
     | ولماذا **قبل** حارس الإعلان أدناه؟ لأنّ غرضه غير غرضه: هذا **قياسٌ داخليّ**
     | (`analytics`)، وذاك بكسل إعلانيّ (`ads`). وكان القياس الداخليّ رهينةَ موافقة
     | الإعلان: من اختار «قياس داخليّ» وحده لم يكن يُقاس له شيء — و«تخصيص» في
     | 21.3-د خيارٌ حقيقيّ لا زينة. والحارس نفسه داخل `capture()`: بلا موافقةٍ
     | صريحة على القياس **لا يُلتقَط شيء** — ولا حتّى في الجلسة.
     */
    app(\App\Services\Growth\AcquisitionSource::class)->capture();
