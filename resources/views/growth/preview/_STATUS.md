# 🗂️ `resources/views/growth/preview` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «preview».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 2.15-أ-7 · 2.16-ب · 21.1-د
...
- **شاشات/أجزاء بليد (2):**
  - `course.blade.php` — بلا ندرة مزيّفة ولا عدّاد وهميّ: نقول العدد الحقيقيّ وخلاص (2.9)
  - `lesson.blade.php` — دعوة صريحة بقيمتها الحقيقيّة مكتوبة — بلا مبالغة (21.1-د)
