...
@php
    ...
    $paths = [
        ...
        'left' => '<path d="m14 5-7 7 7 7"/>', // حرفيًّا من المرجع
        ...
        'audio' => '<path d="M4 9h4l5-4v14l-5-4H4z"/><path d="M17 8a5 5 0 0 1 0 8M19.5 5.5a9 9 0 0 1 0 13"/>',
    ...
    $aliases = [
        ...
        'مساهمة' => 'contribution', 'contributions' => 'contribution',
        ...
        'file' => 'document', 'doc' => 'document', 'pdf' => 'document', 'html' => 'document', 'zip' => 'document',
        ...
        'seat' => 'placement', 'location' => 'placement',
