...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.10.1 · 2.10.1-17 · 2.13 · 2.15-د · 2.15-ج · 2.15-أ-2 · 2.15-أ-3 · 2.15-أ-7 · 2.15-أ-8 · 2.16-ج · 2.16 · 2.17-ج
...
- **شاشات/أجزاء بليد (16):**
  ...
  - `empty.blade.php` — الحالة الفارغة = سطر واحد + زرّ واحد (2.15-د) — تشجّع ولا تعاتب (2.17-ج)
  - `export-image.blade.php` — مساحة اللمس 44×44 شرط قبول على الموبايل (2.15-ج)
  - `filters.blade.php`
  - `first-run.blade.php` — زرّ «؟» يعيدها وقت ما شاء المستخدم (2.15-د)
  - `kpi.blade.php` — كارت KPI — والحدّ الأقصى أربعة في الشاشة (2.15-أ-3)
  - `modal.blade.php` — بوب-أب برأس ثابت وجسم متمرّر بحدّ أقصى 92vh (2.10.1-17)
  - `nav-group.blade.php`
  - `nav-link.blade.php`
  - `page-header.blade.php` — Breadcrumb في كلّ شاشة داخليّة (2.15-د)
  - `saved-views.blade.php`
  - … و4 غيرها.
