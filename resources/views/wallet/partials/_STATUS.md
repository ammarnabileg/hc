# 🗂️ `resources/views/wallet/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/wallet`.
...
- **شاشات/أجزاء بليد (6):**
  - `transactions-rows-desktop.blade.php`
  - `transactions-rows-fragment.blade.php`
  - `transactions-rows-mobile.blade.php`
  - `withdrawals-rows-desktop.blade.php`
  - `withdrawals-rows-fragment.blade.php`
  - `withdrawals-rows-mobile.blade.php`
