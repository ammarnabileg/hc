# 🗂️ `resources/views/notifications/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/notifications`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.8 · 2.15-ب · 2.16-ب · 2.16
...
- **شاشات/أجزاء بليد (1):**
  - `row.blade.php` — نقطة «غير مقروء» — ومعها خلفيّة الصفّ فلا يحمل اللونُ المعنى وحده (2.16-ب)
...
- **المجلّد الأب:** `resources/views/notifications/_STATUS.md`.
