{{--
  ...
  ⚠️ **ولماذا خارج `resources/views/admin/`؟** لأنّها **صفحة المستخدم لا الأدمن**:
     حارس ب-2 (`Tests\Feature\Ui\AdminLayoutGuardTest`) يشترط أن يمتدّ كلّ قالبٍ
     تحت `admin/` من `layouts.admin` — وهو شرطٌ صحيح، فوضعُ هذه الصفحة هناك كان
     سيعرض **سايد بار الإدارة لمتدرّب**. والعلاج نقلُها إلى بيتها الصحيح لا
     التحايل على الحارس بمخرجٍ من الشرط.
--}}
@extends('layouts.app')
