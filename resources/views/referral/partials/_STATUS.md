# 🗂️ `resources/views/referral/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/referral`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 2.9-2 · 2.9-7 · 2.9-8 · 2.10.1 · 2.10.1-11 · 2.13 · 2.15-د · 2.17-ب · 2.17-ج · 7.6 · 7.6.1
...
- **شاشات/أجزاء بليد (3):**
  - `calculator.blade.php` — ثلاثة كروت نتيجة تتحدّث لحظيًّا مع كلّ سحبة (7.6.2)
  - `how-it-works.blade.php`
  - `network.blade.php` — الحالة الفارغة: سطر واحد يشجّع ولا يعاتب (2.15-د · 2.17-ج)
...
- **المجلّد الأب:** `resources/views/referral/_STATUS.md`.
