...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.1 · 2.6-أ · 2.6 · 2.8 · 2.10.1-25 · 2.15-ج · 2.15-ب · 2.15-د · 2.17-ب · 12.2.1-ط · 12.2.1-ز-4 · 13.4-ح
...
- **شاشات/أجزاء بليد (4):**
  ...
  - `guest.blade.php` — التحسين التدريجيّ: رسالة وخطوات تفعيل الجافاسكربت (2.1)
  - `volunteer.blade.php` — شريط تقدّم التمرير (2.10.1-25)
