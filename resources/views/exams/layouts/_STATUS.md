...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.3 · 2.14-ب · 2.17-ب · 24.5
...
- **شاشات/أجزاء بليد (1):**
  - `focus.blade.php` — الحركة تُضبَط من إعداد المستخدم داخل المنصّة لا من تفضيل نظام التشغيل (2.3 · 2.14-ب)
