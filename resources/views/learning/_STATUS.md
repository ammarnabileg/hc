...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-د · 2.15-ج · 2.15-أ-1 · 2.15-أ-2 · 2.15-أ-4 · 2.16 · 2.17-ب · 2.17-أ · 3.1 · 3.2 · 3.3 · 4.1
...
- **شاشات/أجزاء بليد (6):**
  - `course.blade.php` — «مجّاني أوّل مرّة» انتهى بالامتحان والشهادة ⟵ Paywall نفسيّ (16)
  - `courses.blade.php` — فعل رئيسيّ واحد بارز، والباقي في «⋯» (2.15-أ-2)
  - `lesson.blade.php` — [التالي] هو الفعل الرئيسيّ، وسهم [السابق] بجواره (24.5)
  - `path.blade.php` — Roadmap رأسيّ مرقّم: كلّ محطّة = كارت تدريب بترتيبه المعتمَد (3.3)
  - `paths.blade.php`
