# 🗂️ `resources/views/reward-questions` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «reward questions» ضمن: كلّ واجهات المنصّة بالعربيّة — البساطة أوّلًا والموبايل شرط قبول (2.15).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 12.10-أ
...
- **شاشات/أجزاء بليد (1):**
  - `show.blade.php` — تايمر نازل فوق السؤال: ندرة صادقة تحفّز الإجابة الفوريّة (2.9)
