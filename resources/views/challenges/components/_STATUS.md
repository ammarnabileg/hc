# 🗂️ `resources/views/challenges/components` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** مكوّنات بليد خاصّة بالمجلّد الأب لمجلّد `resources/views/challenges`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.3 · 2.13 · 2.14-ب · 2.14 · 2.16-ج · 2.17-أ · 24.5
...
- **شاشات/أجزاء بليد (3):**
  - `celebration.blade.php` — لقطة إنجاز قابلة للمشاركة (2.17-أ) — يبنيها استوديو الصور
  - `champion-row.blade.php` — المركز — وأوّل ثلاثة بتمييز هادئ (ذهبيّ للشرف لا كحالة تشغيليّة)
  - `war-icon.blade.php` — سيفان متقاطعان: حرب المعلومات
