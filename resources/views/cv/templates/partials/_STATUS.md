# 🗂️ `resources/views/cv/templates/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/cv/templates`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 12.7-ب
...
- **المجلّد الأب:** `resources/views/cv/templates/_STATUS.md`.
