# 🗂️ `resources/views/volunteer/escalations/arbitrations/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/escalations/arbitrations`.
...
- **المجلّد الأب:** `resources/views/volunteer/escalations/arbitrations/_STATUS.md`.
