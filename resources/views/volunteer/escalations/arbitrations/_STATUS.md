# 🗂️ `resources/views/volunteer/escalations/arbitrations` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «arbitrations».
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — نمط «قائمة + بانل» موحَّد — وعلى الموبايل العمودان شاشة واحدة (2.15-ج)
  - `show.blade.php`
