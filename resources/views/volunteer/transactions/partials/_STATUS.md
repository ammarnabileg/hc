# 🗂️ `resources/views/volunteer/transactions/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/transactions`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 13.4-ط · 24.4
...
- **شاشات/أجزاء بليد (2):**
  - `objection-panel.blade.php` — المعاملة الأصليّة — لا تُعدَّل أبدًا، والتصحيح بمعاملة عكسيّة (13.4-ط)
  - `reference.blade.php` — أيقونة الكيان بجوار المرجع (24.4)
...
- **المجلّد الأب:** `resources/views/volunteer/transactions/_STATUS.md`.
