# 🗂️ `resources/views/volunteer/reviews/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/reviews`.
...
- **المجلّد الأب:** `resources/views/volunteer/reviews/_STATUS.md`.
