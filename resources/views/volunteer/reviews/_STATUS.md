# 🗂️ `resources/views/volunteer/reviews` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «reviews» ضمن: شاشات لوحة التطوّع بثلاثة عشر عنصرًا في سايد بارها (13.4-ح).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-ج · 2.15-أ-2 · 24.4
...
- **شاشات/أجزاء بليد (2):**
  - `batch.blade.php` — فعل رئيسيّ واحد بارز: الموافقة الجماعيّة بضغطة (2.15-أ-2)
  - `index.blade.php` — تنبيه دائم: المراجِع مقيس ونافذته محسوبة (23 — القسم 5)
