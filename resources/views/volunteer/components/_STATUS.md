# 🗂️ `resources/views/volunteer/components` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** مكوّنات بليد خاصّة بالمجلّد الأب — ضمن: شاشات لوحة التطوّع بثلاثة عشر عنصرًا في سايد بارها (13.4-ح).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-د · 2.16-ب · 13.4-ح · 13.4-ن
...
- **شاشات/أجزاء بليد (2):**
  - `deadline-counter.blade.php` — تواريخ نسبيّة والتاريخ الكامل بالـHover (2.15-د)
  - `rep-badge.blade.php`
