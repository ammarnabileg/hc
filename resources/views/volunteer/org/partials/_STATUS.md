# 🗂️ `resources/views/volunteer/org/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/org`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-ج · 2.15-أ-7 · 2.16-ب · 2.16-ج · 2.16-أ · 2.17-د · 12.2.1 · 13.4-م · 13.4-ص · 13.4-ص-ب · 13.4-م-3 · 24.4-7
...
- **شاشات/أجزاء بليد (6):**
  - `chart-styles.blade.php`
  - `entity-switcher.blade.php`
  - `health-ring.blade.php` — الرمز مع اللون دائمًا — اللون وحده لا يحمل المعنى (2.16-ب)
  - `honorary-line.blade.php`
  - `member-card.blade.php` — الأرقام التشغيليّة للمخوَّل وحده — تُخفى ولا تُعطَّل (2.15-أ-7)
  - `tree-node.blade.php`
...
- **المجلّد الأب:** `resources/views/volunteer/org/_STATUS.md`.
