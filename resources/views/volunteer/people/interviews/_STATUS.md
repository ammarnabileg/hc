# 🗂️ `resources/views/volunteer/people/interviews` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «interviews».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-أ · 2.15-د · 2.15-ج · 2.15-ب · 2.16-أ · 2.17-ب · 13.4-د · 24.4-12
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — التقويم كقائمة أيّام: على الموبايل بلا شبكة مضغوطة ولا تمرير أفقيّ (2.15-ج)
  - `scorecard.blade.php` — النتيجة المغلقة (قرار محفوظ) — تُعرَض للقراءة فقط حتى تُعاد فتحها بصلاحيّة موثّقة (scorecards.restore · 12.2.2...
