# 🗂️ `resources/views/volunteer/people/kudos` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «kudos».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-أ · 2.14 · 2.15-د · 2.16-أ · 2.17-أ · 13.4-ي · 24.4-11
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — Kudos
  - `wall.blade.php` — دخول النادي ⟵ احتفال ذروة (2.14) — والرسالة تنادي باسمه (2.17-أ)
