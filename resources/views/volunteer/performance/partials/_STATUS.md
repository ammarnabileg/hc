# 🗂️ `resources/views/volunteer/performance/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/performance`.
...
- **المجلّد الأب:** `resources/views/volunteer/performance/_STATUS.md`.
