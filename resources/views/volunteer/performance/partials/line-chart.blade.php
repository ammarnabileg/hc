@php
    ...
    /*
     | ⭐ المقارنة بالفارق لا بـ`===`: القيم تخرج من `min()`/`max()` مرّةً int
     | ومرّةً float (min(0.0, 0) = int 0)، فـ`0 === 0.0` تساوي false ويمرّ المنحنى
     | المسطَّح إلى قسمةٍ على صفر. وهذا يقع لكلّ متطوّع جديد، ولكلّ المتطوّعين
     | صباح يوم 1 من كلّ شهر بعد التصفير — أي للشاشة نفسها لا لحالة نادرة.
     */
    $max = (float) $max;
    $min = (float) $min;
