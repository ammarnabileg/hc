# 🗂️ `resources/views/volunteer/profile/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/profile`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.16-ج · 13.4-ن-هـ · 13.4-م · 13.4-م-1 · 13.4-م-2
...
- **شاشات/أجزاء بليد (2):**
  - `header-actions.blade.php` — سطر واحد يوضّح مستوى المشاهدة في طبقة التطوّع (13.4-م)
  - `sparkline.blade.php`
...
- **المجلّد الأب:** `resources/views/volunteer/profile/_STATUS.md`.
