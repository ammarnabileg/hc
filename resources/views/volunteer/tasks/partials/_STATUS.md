# 🗂️ `resources/views/volunteer/tasks/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/tasks`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-د · 24.4-2
...
- **شاشات/أجزاء بليد (3):**
  - `action-modals.blade.php` — تسليم — الساعة تقف هنا والتقييم على وقت التسليم (23-3.7)
  - `card.blade.php`
  - `new-task-modal.blade.php` — خيارات متقدّمة مطويّة، والفورم يعمل كاملًا بدونها (2.15-د)
...
- **المجلّد الأب:** `resources/views/volunteer/tasks/_STATUS.md`.
