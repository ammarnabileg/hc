...
- **آخر نقطة وصلنا لها:** **42** قالب صفحةٍ تحت `volunteer/**` كان يمتدّ `layouts.app` — فتُعرَض شاشة التطوّع في **سايد بار المتدرّب** بدل خريطة **13.4-ح**. نُقِلت كلّها إلى `layouts.volunteer` (الإجماليّ **53/53**)، وبُني حارسٌ ثابتٌ يمسح المجلّد كلّه ويُسقِط أيّ خروجٍ عن القالب — بشبكة أمانٍ تُسقِطه لو صار المجلّد فارغًا: `tests/Feature/Ui/VolunteerLayoutGuardTest.php`.
