# 🗂️ `resources/views/volunteer/goals/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/goals`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.16 · 24.4
...
- **شاشات/أجزاء بليد (1):**
  - `progress.blade.php` — ⭐ المُغلَقة مستبعَدة من المقام وتُوسَم صراحةً كي لا تبدو النسبة مجمَّلة
