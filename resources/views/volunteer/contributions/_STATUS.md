# 🗂️ `resources/views/volunteer/contributions` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «contributions» ضمن: شاشات لوحة التطوّع بثلاثة عشر عنصرًا في سايد بارها (13.4-ح).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-ج · 2.15 · 2.15-أ-3 · 2.15-أ-4
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — مساهماتي
  - `show.blade.php` — بند مساهمة
