# 🗂️ `resources/views/volunteer/contributions/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/volunteer/contributions`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-أ · 2.15-أ-7
...
- **شاشات/أجزاء بليد (1):**
  - `invite-form.blade.php` — نقطتا تفتيش كحدّ أقصى — مواعيد وسيطة سهلة في نفس الصفحة
...
- **المجلّد الأب:** `resources/views/volunteer/contributions/_STATUS.md`.
