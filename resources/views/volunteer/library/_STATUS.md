# 🗂️ `resources/views/volunteer/library` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «library» ضمن: شاشات لوحة التطوّع بثلاثة عشر عنصرًا في سايد بارها (13.4-ح).
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — بحث نصّيّ بارز — وهو بطل الشاشة
  - `item.blade.php`
