# 🗂️ `resources/views/placement/admin/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/placement/admin`.
...
- **المجلّد الأب:** `resources/views/placement/admin/_STATUS.md`.
