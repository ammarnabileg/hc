# 🗂️ `resources/views/placement/admin` — حالة المجلّد
...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.5-د-2 · 2.15-ج · 2.15-أ-6
...
- **شاشات/أجزاء بليد (1):**
  - `index.blade.php` — الخطوة مفعَّلة إعداديًّا لكن بلا سؤال نشِط واحد ⟵ تُتخطّى صامتةً لكلّ مُسجَّل جديد (2.5-د-2)
...
- **المجلّد الأب:** `resources/views/placement/_STATUS.md`.
