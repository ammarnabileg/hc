# 🗂️ `resources/views/admin/content` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «content» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
...
- **مجلّدات فرعيّة (1):** `learning-settings/` — ولكلٍّ منها وثيقتها.
