# 🗂️ `resources/views/admin/content/learning-settings` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «learning settings».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-و · 2.13 · 12.2.2 · 24.4
...
- **شاشات/أجزاء بليد (2):**
  - `field.blade.php`
  - `index.blade.php` — Side Nav لاصق بالمجموعات (24.4) — وعلى الموبايل رقائق أفقيّة
...
- **المجلّد الأب:** `resources/views/admin/content/_STATUS.md`.
