# 🗂️ `resources/views/admin/volunteer/investigations` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «investigations».
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — الطابور: مسودّات آليّة بانتظار «يحتاج قرارك»
  - `show.blade.php` — الحالة
