# 🗂️ `resources/views/admin/volunteer/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/volunteer`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13 · 2.15-ج · 2.15-أ-7 · 13.4-ص-د · 13.4-ك · 24.2
...
- **شاشات/أجزاء بليد (7):**
  - `case-file-assign.blade.php`
  - `honorary-card.blade.php`
  - `hub-setting-field.blade.php`
  - `promotion-ladder-pending.blade.php` — شغور مشرف عام المسار (23-0.2): مساران لا فرق إجرائيًّا بينهما — كودٌ يُبحَث عنه
  - `setting-field.blade.php`
  - `settings-card.blade.php`
  - `tabs.blade.php` — بلا صلاحيّة = مخفيّ فعلًا لا معطَّل (2.15-أ-7)
