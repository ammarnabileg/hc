# 🗂️ `resources/views/admin/scorecard-criteria` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «scorecard criteria» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
...
- **شاشات/أجزاء بليد (1):**
  - `index.blade.php` — 13.4-د: معايير يضيفها الأدمن بلا حدود، يجاوب عليها المشرف بدرجة /10
