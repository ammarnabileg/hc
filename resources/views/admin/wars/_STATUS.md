# 🗂️ `resources/views/admin/wars` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «wars» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
...
- **مجلّدات فرعيّة (1):** `bank/` — ولكلٍّ منها وثيقتها.
