...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 12.15-أ
...
## ⬜ المتبقّي
<!-- بيدك:بداية:المتبقّي -->
- ما فيش فجوة معروفة في هذا المجلّد وقت هذا التحديث — `webhooks.blade.php` لم يعُد سقالة، امتلأ بمحتواه الكامل (12.15-ب).
- لو فتحت فجوة (وعدٌ في الواجهة بلا تنفيذ · إعدادٌ بلا شاشة · مسارٌ بلا صلاحيّة) اكتبها هنا فورًا.
<!-- بيدك:نهاية:المتبقّي -->

## 🔄 الجاري الآن
<!-- بيدك:بداية:الجاري -->
- **الحالة:** مافيش شغل جارٍ — التابان مبنيّان كاملًا.
- **آخر نقطة وصلنا لها:** `webhooks.blade.php` صار يعرض جدول الويب-هوكس وفورم التسجيل وسجلّ المحاولات، بنفس نمط `api.blade.php` حرفيًّا (بوب-أب السرّ مرّة واحدة عبر فلاش الجلسة).
- **الخطوة الجاية:** —
<!-- بيدك:نهاية:الجاري -->
