# 🗂️ `resources/views/admin/moderation` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «moderation» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 12.1 · 12.1-متقدّم-6
...
- **شاشات/أجزاء بليد (1):**
  - `panel.blade.php` — الحالة الحاليّة: السبب الظاهر للمستخدم ومتى ينتهي التعليق
