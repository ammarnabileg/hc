# 🗂️ `resources/views/admin/guidance/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/guidance`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.17-ب
...
- **شاشات/أجزاء بليد (2):**
  - `bell-preview.blade.php` — معاينة الجرس (24.3 سطر 5067) — نفس بطاقة صفّ الجرس الحقيقيّة
  - `list-editor.blade.php`
...
- **المجلّد الأب:** `resources/views/admin/guidance/_STATUS.md`.
