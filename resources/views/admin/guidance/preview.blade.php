...
@section('content')
    <x-page-header
        :title="'معاينة: '.$raw->title"
        subtitle="شوف المنشور بعين القارئ قبل ما تنشره."
        :breadcrumbs="[
        ...
        <x-slot:action>
            <a href="{{ route('admin.guidance.index') }}"
               ...
               style="background: var(--color-brand-500); color: #04201c">رجوع للتحرير</a>
        </x-slot:action>
    </x-page-header>

    {{-- تبديل الجهاز كرقائق — واللون لا يحمل المعنى وحده (2.16) --}}
    <div class="flex items-center gap-2 mb-4" role="group" aria-label="جهاز المعاينة">
    ...
    <div class="card p-4 mt-4">
        <div class="text-sm font-semibold">وسوم التخصيص الديناميكيّ</div>
        <p class="text-xs mt-1" style="color: var(--text-muted)">
            اكتبها في النصّ، وكلّ قارئ هيشوف بياناته هو. والوسم اللي مالوش قيمة بيتبدّل ببديل مهذّب — محدّش هيقرا وسمًا خامًا.
        </p>
