# 🗂️ `resources/views/admin/guidance/email-templates` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «email templates».
...
- **شاشات/أجزاء بليد (1):**
  - `index.blade.php` — قوالب البريد (24.3 سطر 5067 · email_templates.*) — كانت صلاحيّةً بلا شاشة
