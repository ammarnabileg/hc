# 🗂️ `resources/views/admin/trash/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/trash`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13 · 2.15-ج
...
- **شاشات/أجزاء بليد (2):**
  - `panel.blade.php`
  - `table.blade.php` — جدول 5–7 أعمدة على الديسكتوب، وكروت رأسيّة على الموبايل بلا تمرير أفقيّ (2.15-ج)
...
- **المجلّد الأب:** `resources/views/admin/trash/_STATUS.md`.
