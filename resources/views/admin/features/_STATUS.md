# 🗂️ `resources/views/admin/features` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «features» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
...
## ⬜ المتبقّي
<!-- بيدك:بداية:المتبقّي -->
- الشاشة كاملة بعناصر 24.3، والمتبقّي تجميليّ: عمود «أعمدة الجدول» القابل للحفظ لكلّ مستخدم (2.15-د) لم يُبنَ — والمفتاح يظهر دائمًا تحت اسم الميزة بدلًا منه.
<!-- بيدك:نهاية:المتبقّي -->

## 🔄 الجاري الآن
<!-- بيدك:بداية:الجاري -->
- **الحالة:** مُنجَز.
- **آخر نقطة وصلنا لها:** الجدول والبوب-أبات الأربعة وبلوك الإعدادات الخمسة وصفحة «الميزة موقوفة».
- **الخطوة الجاية:** —
<!-- بيدك:نهاية:الجاري -->
