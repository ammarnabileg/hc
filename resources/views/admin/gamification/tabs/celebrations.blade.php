...
<div class="card p-3 mb-4 text-sm space-y-1">
    <div><x-icon name="lock" size="16" /> <strong>ثلاثة مستويات لا رابع</strong> — والحدّ اليوميّ لمستوى الذروة:
        <strong>{{ setting('celebrations.peak.daily_cap', 3) }}</strong> كي تبقى الذروة ذروةً.</div>
    <div><x-icon name="xp" size="16" /> <strong>الأنيميشن حاضر دائمًا بلا توجل</strong> — والصوت وحده يخضع لتوجل الصوت في البروفايل.</div>
    <div><x-icon name="lock" size="16" /> ممنوع الاحتفال بحدث سلبيّ أو بشراء بلا إنجاز — ولا تتراكم: يُعرَض الأعلى مستوى فقط.</div>
</div>
