# 🗂️ `resources/views/admin/gamification/reward-questions` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «reward questions».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 12.10-أ
...
- **شاشات/أجزاء بليد (1):**
  - `results.blade.php` — النتائج بعد الإغلاق (12.10-أ): كم حلّه · نسبة الصحّ · أسرع مجيب
...
- **دفعة النصّ المحروق (2026-08-04):** كلّ نصٍّ عربيّ ظاهر في قوالب هذا المجلّد صار `setting('مفتاح', 'النصّ الحاليّ')` — **13 موضعًا محروقًا ⟵ صفر**، و**12 مفتاحًا** معرَّفةً في `database/seeders/AdminScreenText*DemoSeeder.php` (يستدعيها `SettingDefinitionsSeeder` في مسار الإنتاج). ولا حرفَ تغيّر: الافتراضيّ هو النصّ الذي كان. والعتبة أُحكِمت على هذا المجلّد في `docs/hardcoded-text-baseline.json`.
<!-- بيدك:نهاية:الجاري -->
