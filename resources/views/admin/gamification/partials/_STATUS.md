# 🗂️ `resources/views/admin/gamification/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/gamification`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 12.10-ج
