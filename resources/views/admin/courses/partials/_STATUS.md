# 🗂️ `resources/views/admin/courses/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/courses`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-أ · 2.13 · 2.15-ج · 2.17-ب · 12.4-د · 12.4-هـ · 12.4-ب · 24.1
...
- **شاشات/أجزاء بليد (5):**
  - `bare.blade.php`
  - `media-picker-modal.blade.php` — «ارفع جديد» داخل البوب-أب نفسه: يترفع ويُختار في خطوة واحدة (12.4-د)
  - `nav.blade.php`
  - `sortable.blade.php`
  - `toast.blade.php`
