# 🗂️ `resources/views/admin/report-schedules` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «report schedules» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-د · 2.15-ج · 2.15-أ-5 · 2.15-أ-7 · 24.2 · 24.3-خامسًا
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — تمييز «مافيش تقارير مجدولة أصلًا» عن «الفلتر ما طابقش حاجة» (24.2)
  - `log.blade.php` — الرابط المؤقّت يظهر فقط ما دام شغّالًا — والمنتهي يُخفى لا يُعطَّل (2.15-أ-7)
