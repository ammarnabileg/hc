# 🗂️ `resources/views/admin/report-schedules/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/report-schedules`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 24.3-خامسًا
