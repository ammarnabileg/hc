...
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.9 · 12.2.1 · 19.5-أ · 19.5-ب-4 · 19.5-ب-5
...
- **شاشات/أجزاء بليد (5):**
  - `gateway.blade.php` — إعدادات بوّابة الدفع
  - `index.blade.php` — طلبات الشحن
  - `methods.blade.php` — طرق التحويل وعروض الشحن
  - `show.blade.php` — مراجعة طلب شحن
  - `webhooks.blade.php` — سجلّ الـWebhook الخام
