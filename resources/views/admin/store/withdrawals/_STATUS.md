# 🗂️ `resources/views/admin/store/withdrawals` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «withdrawals».
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — ⭐ تاب بعدّاد N لأيّ جديد — والحالات الأربع لا خامس لها
  - `show.blade.php`
