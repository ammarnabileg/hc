# 🗂️ `resources/views/admin/store/finance` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** شاشات وأجزاء واجهة «finance».
- **البنود الحاكمة (من تعليقات الكود نفسه):** 24.3
...
- **شاشات/أجزاء بليد (3):**
  - `audit.blade.php`
  - `index.blade.php` — Side Nav لاصق بالمجموعات (24.3) — وعلى الموبايل رقائق أفقيّة
  - `refund-policy.blade.php` — المعاينة تُعرَض في صندوق معزول لأنّ النصّ قد يحمل HTML كاملًا
