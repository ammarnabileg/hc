# 🗂️ `resources/views/admin/question-bank` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «question bank» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.13-د · 2.15-ج · 2.15-أ-2 · 2.15-أ-3 · 2.15-أ-4 · 2.15-أ-5 · 2.15-أ-7 · 24.1-3 · 24.2
...
- **شاشات/أجزاء بليد (2):**
  - `index.blade.php` — الباقي في «⋯» — فعل رئيسيّ واحد بارز (2.15-أ-2)
  - `preview.blade.php`
...
- **دفعة النصّ المحروق (2026-08-04):** كلّ نصٍّ عربيّ ظاهر في قوالب هذا المجلّد صار `setting('مفتاح', 'النصّ الحاليّ')` — **90 موضعًا محروقًا ⟵ صفر**، و**71 مفتاحًا** معرَّفةً في `database/seeders/AdminScreenText*DemoSeeder.php` (يستدعيها `SettingDefinitionsSeeder` في مسار الإنتاج). ولا حرفَ تغيّر: الافتراضيّ هو النصّ الذي كان. والعتبة أُحكِمت على هذا المجلّد في `docs/hardcoded-text-baseline.json`.
<!-- بيدك:نهاية:الجاري -->
