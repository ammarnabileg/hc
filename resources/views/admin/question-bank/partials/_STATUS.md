# 🗂️ `resources/views/admin/question-bank/partials` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** أجزاء بليد قابلة لإعادة الاستعمال داخل شاشات المجلّد الأب لمجلّد `resources/views/admin/question-bank`.
- **البنود الحاكمة (من تعليقات الكود نفسه):** 2.15-أ-7 · 24.1-3
...
- **المجلّد الأب:** `resources/views/admin/question-bank/_STATUS.md`.
