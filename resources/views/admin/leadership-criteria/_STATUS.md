# 🗂️ `resources/views/admin/leadership-criteria` — حالة المجلّد
...
## 🎯 الغرض/المطلوب
<!-- تلقائيّ:بداية:الغرض -->
- **الوظيفة:** «leadership criteria» ضمن: شاشات لوحة الإدارة باثنَي عشر قسمًا في السايد بار (12.0).
...
- **شاشات/أجزاء بليد (1):**
  - `index.blade.php` — 13.4-ن-د: بنود يحدّدها الأدمن، يقيَّم عليها الأبلاين أسبوعيًّا من داونلاينه
